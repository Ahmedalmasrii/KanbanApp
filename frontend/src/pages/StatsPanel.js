...
const StatsPanel = () => {
  ...
  const statCards = [
    {
      title: "Totalt antal beställningar",
    ...
    <div className="p-6 min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
        {statCards.map((card, index) => (
          <div
            key={index}
            className="bg-gray-800 p-5 rounded-2xl shadow-md flex items-center justify-between hover:shadow-lg transition duration-300"
          >
